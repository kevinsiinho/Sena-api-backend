...
class Backend extends (0, boot_1.BootMixin)((0, service_proxy_1.ServiceMixin)((0, repository_1.RepositoryMixin)(rest_1.RestApplication))) {
    constructor(options = {}) {
        super(options);
        ...
        this.dataSource(datasources_1.DbProyectoDataSource, authentication_jwt_1.UserServiceBindings.DATASOURCE_NAME);
